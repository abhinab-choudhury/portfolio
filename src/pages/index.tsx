  ...
  const projects: {
    ...
    blog_url?: string;
      ...
      },
      {
        ...
        description: "A News Client with a AI Power News Summarization Chrome Extension, CLI interface and Website also supports Hacker News",
      ...
      },
      {
        ...
        description: "A full-stack task management application with user authentication, real-time updates, and a responsive design, with HTML, CSS and Javascript.",
